...
- [GitHub push authentication](github-push-auth.md) — this workspace's GitHub token may reject bearer auth; basic auth with x-access-token works without exposing the token.
