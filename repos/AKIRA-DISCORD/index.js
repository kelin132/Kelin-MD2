...
const { startDiscordBumpScheduler } = await import("./lib/discordBump.mjs");
const { startDiscordTicketScheduler } = await import("./lib/discordTickets.mjs");
...
async function start() {
  ...
  try {
    ...
    await startDiscordTicketScheduler(client);
