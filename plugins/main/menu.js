...
const PUBLIC_CATS = new Set([
  ...
  "search", "media", "utilities", "download", "group", "anime", "cards", "staff", "naruto", "pokemon", "pets","image",
]);
...
export default {
  ...
  async run({ sock, msg, prefix, isOwner, isStaff, isMod, sender }) {
    ...
    // Ordered list
    const order = [
      "main", "economy", "guild", "pets", "cards","naruto","pokemon","games", "fun", "ai",
      "search", "media", "image","utilities", "download", "group", "admin", "anime", 
      ...(showStaff ? ["staff"] : []),
      ...(showOwner ? ["owner"] : []),
    ];
...
> © AKIRA`;
    ...
    await sock.sendMessage(
      jid,
      {
        image:    { url: "https://cdn.phototourl.com/free/2026-07-21-15f31899-103f-4c9e-ba3c-16f0ffe0e2e7.jpg" },
        caption:  text,
        mentions: [sender],
      },
      { quoted: msg }
