...
function replyHint(forceShort, detailed, mode) {
  ...
  return `\n\nReply direction: embody ${mode}. Sound like Akira, an anime girl friend, not an AI assistant explaining a mood. Add at most one small expressive anime cue if it fits. ${lengthRule} ${shortRule}`;
}
