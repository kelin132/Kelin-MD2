/**
 * KELIN MD — Akira AI core (powered by David Cyril Dolphin API — no key needed)
...
import { askDolphin } from "./davidcyrilAPI.mjs";
...
export async function callAkira(sock, msg, userText) {
  ...
  try {
    ...
    const reply  = await askDolphin(prompt, uid);
