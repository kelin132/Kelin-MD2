...
import { randomTrainer, randomTrainerPair } from "./trainers.mjs";
...
export function startWildBattle(chatId, battler, wild) {
  const state = {
    ...
    challengerTrainer: randomTrainer(),
    opponentJid: null,
    opponentName: "Wild",
...
export function startPvPBattle(chatId, challenger, opponent) {
  ...
  state.challengerTrainer = trainerPair.challenger;
  state.opponentTrainer = trainerPair.opponent;
  battles.set(chatId, state);
  return state;
}
