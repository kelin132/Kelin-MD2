...
export const MART_ITEMS = {
  ...
  masterball:  { name: "Master Ball",     price: 3500,  desc: "80% catch rate. Almost guaranteed to catch.",                category: "ball",    emoji: "🟣", page: 1 },
  ...
  beastball:   { name: "Beast Ball",      price: 12000, desc: "100% catch rate — GUARANTEED to catch any wild Pokémon. No luck needed.",  category: "ball",    emoji: "🔶", page: 1 },
