...
export async function generateBattleScene({ player, enemy, round = 1, hitSide = null, damage = null, crit = false, statusText = "" }) {
  ...
  // Larger size so both Pokémon feel big and prominent on screen
  const enemySize = 270;
  ...
  // Larger than enemy (closer perspective, front-facing)
  ...
  if (playerImg) {
    // No flip — player's front sprite faces the viewer; placed on the left it reads as facing right toward the enemy
