...
import { handleWordChainText } from "../plugins/games/wordchain.js";
    ...
    sock.ev.on("messages.upsert", async ({ messages, type }) => {
      ...
      for (const msg of messages) {
        ...
        try {
          ...
          const identity = await resolveMessageIdentity(sock, msg);
          await normalizeMessageReferences(sock, msg);
          const senderJid = identity.jid || msg.key.participant || msg.key.remoteJid || "";
          ...
          await akiraHandler({ sock, msg, prefix: runtime.prefix || _prefix });
          await handleTodText(sock, msg);
          await handleWordChainText(sock, msg, runtime.prefix || _prefix);
