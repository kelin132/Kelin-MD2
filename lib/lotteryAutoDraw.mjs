      ...
      if (lot.totalTickets >= LOTTERY_MAX_ENTRIES) {
        ...
        if (automaticDraw) {
          return sock.sendMessage(jid, {
            text: formatLotteryResults(automaticDraw),
            mentions: automaticDraw.winners?.map(w => asJid(w.userId)) || []
          }, { quoted: msg });
        }
      }
...
╰━━━━━━━━━━━━━━━━━━━━╯`
      ...
      // Format tag explicitly as @userId inside message text
      const tagMention = `@${winner.userId.split("@")[0]}`;
