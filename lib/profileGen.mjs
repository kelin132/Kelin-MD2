...
export async function generateProfileImage(data) {
  ...
  if (customBackground) {
    ...
    roundRect(ctx, panelX, panelY, panelW, panelH, 38);
    ctx.clip();
    drawImageCover(ctx, customBackground, panelX, panelY, panelW, panelH);
    ctx.fillStyle = "rgba(12, 15, 30, 0.78)";
  ...
  ctx.textAlign = "center";
  ctx.textBaseline = "alphabetic";
  ctx.fillText(fitText(ctx, username.toUpperCase(), 650), W / 2, 505);
