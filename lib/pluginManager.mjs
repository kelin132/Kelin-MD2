...
import { buildEconomyLinkPreview, getEconomyPreviewConfig, hasEconomyPreview } from "./economyPreview.mjs";
...
export async function routeMessage(sock, msg, prefix = ".", ownerNumber = "", fromMe = false) {
  ...
  const shouldAttachPreview = hasEconomyPreview(cmd) && plugin.name !== "mart";
