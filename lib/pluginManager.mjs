...
import { buildEconomyLinkPreview, buildEconomyExternalAdReply, hasEconomyPreview } from "./economyPreview.mjs";
          ...
          return async (chatId, content = {}, options) => {
            if (!previewSent && content && typeof content === "object" && typeof content.text === "string" && !content.linkPreview) {
              ...
              if (linkPreview) {
                ...
                previewSent = true;
                try {
                  return await target.sendMessage.call(target, chatId, content, options);
                } catch (previewError) {
