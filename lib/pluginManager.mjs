...
import { buildEconomyLinkPreview, hasEconomyPreview, withHiddenPreviewUrl } from "./economyPreview.mjs";
        ...
        get(target, property) {
          ...
          return async (chatId, content = {}, options) => {
            if (!previewSent && content && typeof content === "object" && typeof content.text === "string" && !content.linkPreview) {
              ...
              if (linkPreview) {
                content = { ...content, text: withHiddenPreviewUrl(content.text, plugin.name), linkPreview };
                previewSent = true;
              }
            }
