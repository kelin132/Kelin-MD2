  ...
  async run({ sock, msg, sender }) {
    ...
    try {
      sceneBuffer = await generateBattleScene({
        player: { name: lead.displayName || lead.name, pokedexId: lead.pokedexId, level: lead.level, hp: lead.hp, maxHp: lead.maxHp, imageUrl: lead.backImageUrl || lead.imageUrl, shiny: lead.shiny },
